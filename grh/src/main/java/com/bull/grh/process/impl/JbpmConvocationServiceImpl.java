...
public class JbpmConvocationServiceImpl extends JbpmServiceImpl implements
		JbpmConvocationService {
	...
	public void startAndCompleteTask(String userID, Task task,
			EntretienVO entretien, boolean disponible) {
		Map<String, Object> dataInput = new HashMap<String, Object>();
		addDataInput(dataInput, ProcessConst.CONVOCATION_DISPONIBLE, disponible);
		addDataInput(dataInput, ProcessConst.CONVOCATION_ENTRETIEN, entretien);
	...
	public List<Task> getStartedTaskList(String role) {
		return getStartedTaskList(ProcessConst.CONVOCATION_TASK_CONVOCATION,
				role);
	}

	@Override
	public Long getCountStartedTaskList(String role) {
		return getCountStartedTaskList(
				ProcessConst.CONVOCATION_TASK_CONVOCATION, role);
	}
